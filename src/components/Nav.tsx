...
import Cartlcons from './Cart/Cartlcons';


export default function Nav() {
  return (
    <nav class="flex justify-between items-center font-semibold bg-gradient-to-r from-primary to-accent text-primary-content p-5 gap-3">
